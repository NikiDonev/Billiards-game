...
public:
	...
	struct Pallete {
		const sf::Color tableColor, cushionColor, railsColor, cornerColor, pocketColor;
	};
	Pallete p[7] = {
		{ sf::Color(0x3bc464FF) ,sf::Color(0x19940cFF) ,sf::Color(0x9c6833FF),sf::Color(0x824e05FF),sf::Color::Black },
		{ sf::Color(0x5A2784FF) ,sf::Color(0x431C63FF) ,sf::Color(0x9c6833FF),sf::Color(0x824e05FF),sf::Color::Black },
		{ sf::Color(0x1F7A43FF) ,sf::Color(0x16572FFF) ,sf::Color(0x835824FF),sf::Color(0x794404FF),sf::Color::Black },//green
		{ sf::Color(0x1D63B3FF) ,sf::Color(0x13437AFF) ,sf::Color(0xA6AEB5FF),sf::Color(0xE6E6E6FF),sf::Color::Black },//blue
		{ sf::Color(0x5A2784FF) ,sf::Color(0x3D1A59FF) ,sf::Color(0xD2A172FF),sf::Color(0xF3E5ABFF),sf::Color::Black },//purple
		{ sf::Color(0x4682B4FF) ,sf::Color(0x2E5678FF) ,sf::Color(0xCDB89CFF),sf::Color(0x3A3B3CFF),sf::Color::Black } // light blue
